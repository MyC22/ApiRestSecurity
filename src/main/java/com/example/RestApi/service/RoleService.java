...
import com.example.RestApi.repository.RoleMapper;
...
public class RoleService {
    ...
    @Transactional
    public Optional<NotUserDto> addRoleToUser(Long userId, List<String> roleNames) {
...
//        logAudit("ASSIGN_ROLE", "User", user.getId());
    ...
    @Transactional
    public Optional<NotUserDto> removeRoleFromUser(Long userId, List<String> roleNames) {
        UserEntity user = getUserById(userId);
